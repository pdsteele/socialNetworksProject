pdf(file='testComparison_clustering.pdf')
...
pdf(file='testComparison_hop.pdf')
...
pdf(file='testComparison_inDeg.pdf')
...
pdf(file='testComparison_outDeg.pdf')
...
pdf(file='testComparison_recipDeg.pdf')
