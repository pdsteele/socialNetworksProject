//g++ -Wall -D__STDC_LIMIT_MACROS -O3 -DNDEBUG -o demo-bfsdfs demo-bfsdfs.cpp ./Snap-2.2/snap-core/Snap.o -I./Snap-2.2/snap-core -I./Snap-2.2/glib-core
...
//  }
  ...
  printf("Ending benchmark! Took: %.f seconds \n", seconds);
