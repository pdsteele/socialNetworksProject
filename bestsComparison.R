pdf(file='bestsComparison_clustering.pdf')
...
pdf(file='bestsComparison_hop.pdf')
...
pdf(file='bestsComparison_inDeg.pdf')
...
pdf(file='bestsComparison_outDeg.pdf')
...
pdf(file='bestsComparison_recipDeg.pdf')
